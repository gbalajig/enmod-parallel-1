#ifndef ENMOD_PARALLEL_DYNAMIC_BIDP_SOLVER_H
#define ENMOD_PARALLEL_DYNAMIC_BIDP_SOLVER_H

#include "DynamicSolver.h"
#include "Types.h"

class ParallelDynamicBIDPSolver : public Solver {
public:
    ParallelDynamicBIDPSolver(const Grid& grid_ref);
    void run() override;
...
#endif // ENMOD_PARALLEL_DYNAMIC_BIDP_SOLVER_H