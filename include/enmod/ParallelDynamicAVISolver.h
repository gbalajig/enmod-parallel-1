#ifndef ENMOD_PARALLEL_DYNAMIC_AVI_SOLVER_H
#define ENMOD_PARALLEL_DYNAMIC_AVI_SOLVER_H

#include "DynamicSolver.h"
#include "Types.h"

class ParallelDynamicAVISolver : public Solver {
public:
    ParallelDynamicAVISolver(const Grid& grid_ref);
    void run() override;
...
#endif // ENMOD_PARALLEL_DYNAMIC_AVI_SOLVER_H